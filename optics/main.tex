...
\begin{align}
  ...
  F &= a^2 / z \lambda\\ % https://en.wikipedia.org/wiki/Fresnel_number
  d &= \lambda / 2 NA\\ % https://en.wikipedia.org/wiki/Diffraction-limited_system
